...
const DialogueData = {
  ...
  level_11: {
    text: [
      ...
      "I sHalL dEciDe THe right pUnisHMent!",
    ...
    triggerIndex: [120, 0, 1, 2, 1750],
    ttl: [200, 200, 200, 200, 200],
  },
  beforeTheBoss: {
    text: [
      "There you are!#Calmed up now? Great.",
      "First of all:#You don't belong here.#Your place is in the upper networks.",
      "Second:#She brought you down here#to help her take revenge#on 'certain' people.",
      "These people did some terrible things.#So punishment is indeed an eternal#servitude in the hellcoin mines.",
      ...
      "Mind saving me a couple of workers?",
    ],
    ...
    triggerIndex: [120, 0, 1, 2, 3, 4, 5, 6, 7],
    ttl: [200, 200, 200, 200, 200, 200, 200, 200, 10000],
  },
  level_12: {
    text: [
