...
const DialogueData = {
  ...
  level_13: {
    text: [
      ...
      "IF yOU can hOlD tHEm#Off OnE MoRE TIme,I CaN FOcus on#the DeLeTIon pRoceSS.",
      "Do you two even realise,#what you're doing?",
      "",
    ],
    color: ["#adadad", "#adadad", "#adadad", "red", "red"],
    triggerType: ["timer", "after", "after", "wave", "after"],
    triggerIndex: [240, 0, 0, 4, 3],
    ttl: [200, 200, 200, 200, 200],
  },
};
