...
const DialogueData = {
  ...
  level_0: {
    ...
    text: [
      ...
      "WARNING: FIREWALL INTEGRITY 80%#INTRUDERS DETECTED IN THE SECTOR 4.",
      "Oh no... they're already here...",
      "Please, just... try to hold them off.#I'll think of something to help us out.",
      "I'll try to deny access to as many as I can!#The rest needs to be eliminated ASAP.",
      "...you're doing good by the way!",
    ],
    color: ["white", "white", "orange", "white", "white", "white", "white"], //color of the displayed text (colors distinguish characters)
    /*
    Trigger types
    timer - level timer
    ...
    */
    triggerType: ["timer", "after", "after", "after", "after", "wave", "after"],
    triggerIndex: [240, 0, 1, 2, 3, 3, 5], //specific trigger value (e.g. timer => 240 frames)
    ttl: [150, 1, 150, 150, 150, 150, 150], //ttl - time to stay on the screen after typing is done
  },
  level_1: {
    text: [
      "Adjacent networks are full of them!",
      "It's... scary... we need more time!",
    ...
    color: ["white", "white", "white", "white", "orange"],
    triggerType: ["timer", "after", "wave", "after", "wave"],
    triggerIndex: [240, 0, 2, 3, 3],
    ttl: [150, 150, 150, 150, 150, 150],
  },
  level_2: {
    text: [
      ...
      "Just a little longer!#Gosh, I wish these ancient drivers weren't#so complicated.",
    ],
  ...
  level_3: {
    text: [
      "I've restored a defense node to help you out.",
      "It's very primitive and not intelligent,#but it can copy your attacks and movement.",
      "This is bad... I'm sensing some heavy disturbance#heading our way.",
  ...
  level_4: {
    text: [
      "It's done! The drivers are set up!",
    ...
    ttl: [150, 1, 150, 1, 100, 1, 100, 1, 1, 1, 1, 1, 1, 1, 1, 1, 100],
  },
  level_5: {
    text: [
      "CRITICAL: FIREWALL UNRESPONDING",
      "...they've sealed my admin control#over the system...#I can't do anything.",
    ...
    ttl: [150, 150, 150, 150, 150, 150, 150],
  },
  level_6: {
    text: [
    ...
    ttl: [150, 150, 150, 150, 150],
  },
  level_7: {
    text: [
      "Pitiful.#Do you realize who you are#dealing with, Angela?",
      "Your actions shall meet consequences.",
      "WARNING: SECTOR 4 UNRESPONDING",
      "The control panel is being overloaded.#We should be able to force it to restart#this way and regain control.",
  ...
  level_8: {
    text: [
      ...
      "Why are you helping her?#She's clearly usin",
      ...
      "Poor thing has no idea what's goin",
      "CAN YOU JUST S",
      "SHuT ThE Fu*-&!_@",
      "stop already?!",
    ],
    color: ["red", "red", "white", "white", "red", "red", "red", "white", "#adadad", "white"],
    triggerType: [
      "timer",
      "after",
      "after",
    ...
    ttl: [150, 1, 150, 150, 150, 150, 1, 1, 1, 150],
  },
  level_9: {
    text: [
      "Located enough resources for#probably the last defense node.",
      "I won't be able to find more,#because the network is almost#unresponsive now.",
      "You're in no position to disobey#what has been set.",
      "Surrender now and you might#still have a chance.",
      "Let me have my justice and then we#can talk!",
  ...
  level_10: {
    text: [
      ...
      "I'lL KiLl yOuuuuuU&@!<",
      "THIS HURTS ME?!",
      "'after 6 hits by a baseball bat and 3 knife#stabs s",
      "THESE PEOPL",
    ...
    ttl: [150, 1, 150, 1, 1, 1, 150, 1, 1, 150],
  },
  level_11: {
    text: [
  ...
  beforeTheBoss: {
    text: [
      ...
      "Normally, I wouldn't give a damn#about a few workers.#But she's disgracing OUR#and YOUR ways.",
      "So, what do you say?",
      ...
      "Fine. Check the console after you#get both endings done.",
    ],
    color: [
      "red",
      "red",
    ...
    ttl: [150, 150, 150, 150, 150, 150, 150, 150, 150, 1200, 600, 600, 600, 600, 600, 600],
  },
  level_12: {
    text: [
      "So, yOu aRe HerE To STop Me?",
      "UnForTUnaTelY For yOU,#I'm dOnE beINg NICe.",
      "N0on€ w1Ll dEnY M7 VenGE@nc€.",
      "RElFIERJRSBESUUgRElFLg==",
    ],
    color: ["#adadad", "#adadad", "#adadad", "#adadad"],
    triggerType: ["timer", "after", "wave", "wave"],
    triggerIndex: [240, 0, 2, 3],
    ttl: [150, 150, 150, 150],
  },
  level_13: {
    text: [
      ...
      "AftER all Of thAT...",
      "ThANk yoU.",
      "My master isn't pleased with#your doing.",
      "You have been condemmed to#an annihilation.",
      "I'm geTTinG cLose.#Don't GiVe UP noW!",
      "Deletion succesful (4 files deleted).",
    ...
    triggerIndex: [240, 0, 2, 2, 3, 4, 6, 6, 11, 15, 9],
    ttl: [150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150],
  },
};
...
const WeaponData = {
  ...
  MISSILE: {
    index: 3,
    sprite: sprite.projectile_MISSILE,
    name: "MISSILE",
    sound: "player_MISSILE",
    animation: false,
    rotationAnimation: false,
    explosive: true,
    bullets: 1,
