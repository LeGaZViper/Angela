...
var defaultWeaponDatabase = {
  ...
  DOUBLE:{name:"DOUBLE",bullets:2,damage:1,speed:15,width:4,height:25,cooldown:150,color:"#04F7FF",status:"LOCKED",cost:0},
  ...
  LASER:{name:"LASER",bullets:1,damage:4,speed:0,width:1,height:1,cooldown:2000,piercing:true,hitCD:200,color:"#00FF00",status:"LOCKED",cost:0},
...
var defaultShipDatabase = {
  SCOUT:{name:"SCOUT",speed:10,width:60,height:60,widthOnPic:88,heightOnPic:88,particles:[22,2,30,0,0.1],maxHP:[10,5],status:"UNLOCKED",cost:0,section:1,level:1,weapon:defaultWeaponDatabase.BASIC},
  SLUG:{name:"SLUG",speed:10,width:88,height:88,widthOnPic:88,heightOnPic:88,particles:[23,45,23,0,0.1],maxHP:[10,10],status:"LOCKED",cost:0,section:2,level:1,weapon:defaultWeaponDatabase.DOUBLE},
  ORBITER:{name:"ORBITER",speed:10,width:55,height:83,widthOnPic:55,heightOnPic:83,particles:[0,0,0,0,0],maxHP:[10,5],status:"LOCKED",cost:0,section:3,level:1,weapon:defaultWeaponDatabase.ROCKET}
};
